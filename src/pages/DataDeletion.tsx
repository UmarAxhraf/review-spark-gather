        ...
        <CardContent>
          <div className="space-y-6">
            ...
            <div className="bg-green-50 p-4 rounded-lg">
              <h3 className="font-semibold mb-3">Method 2: Email Request</h3>
              <p>Send an email to <strong>privacy@yourdomain.com</strong> with:</p>
            ...
            <p className="text-sm text-muted-foreground">
              ...
              Some information may be retained for legal compliance purposes as outlined in our Privacy Policy.
            </p>
          </div>
        </CardContent>
      </Card>
