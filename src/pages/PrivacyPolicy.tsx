        ...
        <CardContent className="prose max-w-none">
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              you create an account, connect social media platforms, or contact
              us for support.
            </p>
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                Social media platform data (Facebook Pages, Google Business
                profiles, Yelp business information)
              </li>
          ...
          <section className="mb-8">
            ...
            <ul className="list-disc pl-6 mb-4">
              ...
              <li>
                Aggregate and analyze review data from your connected platforms
              </li>
          ...
          <section className="mb-8">
            ...
            <p className="mb-4">
              ...
              Facebook, Google Business, and Yelp. When you connect these
              accounts:
            </p>
            <ul className="list-disc pl-6 mb-4">
              <li>
                We access only the data necessary to provide our review
                management services
              </li>
              <li>
                We store access tokens securely and use them only for authorized
                purposes
              </li>
              <li>
                You can disconnect these integrations at any time through your
                account settings
              </li>
              <li>
                Each platform's own privacy policy also applies to data they
                collect
              </li>
            </ul>
          </section>
          ...
          <section className="mb-8" id="data-deletion">
            ...
            <div className="bg-blue-50 p-4 rounded-lg mt-4">
              ...
              <ol className="list-decimal pl-6">
                <li>
                  Log into your account and go to Settings to view your data
                </li>
                <li>
                  email us at support@syncreviews.com with your deletion request
                </li>
