...
//     try {
//       // Use public client for fetching employee data
...
//       // Fetch company settings using public client
...
//   //     // Use public client for video upload with explicit headers
//   //     const { data, error } = await publicSupabase.storage
//   //       .from("video-reviews")
...
//   //     const {
//   //       data: { publicUrl },
//   //     } = publicSupabase.storage.from("video-reviews").getPublicUrl(filePath);
...
//         try {
//           const { data, error: reviewError } = await publicSupabase
//             .from("reviews")
//             .insert({
...
//           retryCount++;
//           console.error(
//             `Review submission attempt ${retryCount} failed:`,
//             error
//           );
